...
--
-- Host: 127.0.0.1
-- Creato il: Feb 02, 2021 alle 23:10
...
--
-- Database: `codicicatastali`
--

-- --------------------------------------------------------

--
-- Struttura della tabella `codicicatastali`
--

CREATE TABLE `codicicatastali` (
  `Luogo` varchar(46) DEFAULT NULL,
  `CodiceCatastale` varchar(4) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dump dei dati per la tabella `codicicatastali`
--

INSERT INTO `codicicatastali` (`Luogo`, `CodiceCatastale`) VALUES
('Agliè', 'A074'),
('Airasca', 'A109'),
('Ala di Stura', 'A117'),
...
('GERMANIA (GERMANIA REPUBBLICA FEDERALE)', 'Z112'),
('GIBILTERRA', 'Z113'),
...
('MAN (ISOLA)', 'Z122'),
('MONACO', 'Z123'),
('NORMANNE (ISOLE)=ISOLE DEL CANALE', 'Z124'),
('NORVEGIA', 'Z125'),
('PAESI BASSI', 'Z126'),
('POLONIA', 'Z127'),
('PORTOGALLO', 'Z128'),
...
('ARMENIA', 'Z137'),
('UCRAINA', 'Z138'),
('BIELORUSSIA=RUSSIA BIANCA', 'Z139'),
('MOLDAVIA', 'Z140'),
('AZERBAIGIAN', 'Z141'),
('KIRGHIZISTAN', 'Z142'),
('UZBEKISTAN', 'Z143'),
...
('FILIPPINE', 'Z216'),
('REPUBBLICA DELLA CINA NAZIONALE=TAIWAN', 'Z217'),
...
('SINGAPORE', 'Z248'),
('BANGLADESH', 'Z249'),
('YEMEN REPUBBLICA DEMOCRATICA POPOLARE', 'Z250'),
('VIETNAM', 'Z251'),
('ARMENIA', 'Z252'),
('AZERBAIGIAN', 'Z253'),
('GEORGIA', 'Z254'),
...
('TURKEMENISTAN', 'Z258'),
('UZBEKISTAN', 'Z259'),
('NAMIBIA=AFRICA DEL SUD OVEST', 'Z300'),
('ALGERIA', 'Z301'),
('ANGOLA', 'Z302'),
...
('CENTROAFRICANA REPUBBLICA', 'Z308'),
('CENTROAFRICANO IMPERO', 'Z308'),
('CIAD', 'Z309'),
('COMORE (ISOLE)', 'Z310'),
('COMORE', 'Z310'),
...
('GHANA', 'Z318'),
('GUINEA', 'Z319'),
('GUINEA PORTOGHESE', 'Z320'),
('GUINEA BISSAU', 'Z320'),
('GUINEA SPAGNOLA', 'Z321'),
...
('SIERRA LEONE', 'Z344'),
('SOMALIA', 'Z345'),
('TERRITORIO FRANCESE DEGLI AFAR E DEGLI ISSA', 'Z346'),
('SOMALIA FRANCESE', 'Z346'),
('SUDAFRICANA REPUBBLICA', 'Z347'),
('SUDAN', 'Z348'),
('SWAZILAND', 'Z349'),
('SWAZILAND-SUDAFRICA BRITANNICO', 'Z349'),
('TANGANICA', 'Z350'),
('TOGO', 'Z351'),
('TUNISIA', 'Z352'),
('UGANDA', 'Z353'),
('BURKINA', 'Z354'),
('VOLTA=ALTOVOLTA', 'Z354'),
('ZAMBIA', 'Z355'),
('ZANZIBAR', 'Z356'),
('TANZANIA', 'Z357'),
('BOTSWANA', 'Z358'),
...
('SAINT KITTS E NEVIS=SAINT CHRISTOPHER E NEVIS', 'Z533'),
('ARGENTINA', 'Z600'),
('BOLIVIA', 'Z601'),
('BRASILE', 'Z602'),
('CILE', 'Z603'),
('COLOMBIA', 'Z604'),
('ECUADOR', 'Z605'),
('GUYANA BRITANNICA', 'Z606'),
('GUYANA', 'Z606'),
('GUAYANA=GUIANA FRANCESE', 'Z607'),
('GUAYANA OLANDESE', 'Z608'),
('SURINAME', 'Z608'),
('MALVINE=FALKLAND (ISOLE)', 'Z609'),
('PARAGUAY', 'Z610'),
('PERU\'', 'Z611'),
...
('VENEZUELA', 'Z614'),
('AUSTRALIA', 'Z700'),
('CAROLINE (ISOLE)=STATI FEDERATI DI MICRONESIA', 'Z701'),
('CAROLINE (ISOLE)', 'Z701'),
('CHRISTMAS (ISOLA)', 'Z702'),
('COOK (ISOLE)', 'Z703'),
('FIGI=VITI', 'Z704'),
('FIGI=VITI (ISOLE)', 'Z704'),
...
('SAMOA', 'Z726'),
('TOKELAU=ISOLE DELL\'UNIONE', 'Z727'),
('TONGA=DEGLI AMICI (ISOLE)', 'Z728'),
('TONGA=ISOLE DEGLI AMICI', 'Z728'),
...
--
-- Indici per le tabelle `codicicatastali`
--
ALTER TABLE `codicicatastali`
  ADD KEY `COL 1` (`Luogo`);
COMMIT;
